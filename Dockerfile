...
COPY --chown=appuser:appuser . /home/appuser/app/movies

# Required in Windows and MAC OS to run the entrypoint.sh script
RUN sed -i 's/\r$//' /home/appuser/app/movies/entrypoint.sh \
    && chmod 744 /home/appuser/app/movies/entrypoint.sh

RUN mv /home/appuser/app/movies/entrypoint.sh /usr/local/bin/entrypoint.sh
